...
const Timer = () => {
  ...
  const [minute, setHours] = useState(25);
...
>>>>>>> bff2c50772cdde6e1c3934ef85fa9c4543f4f897
...
=======
  ...
  return (
    <div style={{ textAlign: "center", margin: "auto" }}>
      ...
      <button className="up" onClick={onClickInc}>
        inc
      </button>
      <button className="down" onClick={onClickDec}>
        dec
      </button>
      {/* <button className='VoteButton' onClick={onClickStart}><ArrowUpward /> </button>
>>>>>>> bff2c50772cdde6e1c3934ef85fa9c4543f4f897
